...
class LoginView(tk.Frame):
    ...
    def _build(self):
        ...
        self._status = tk.Label(self, text="", fg="red", bg="white", font=("", 9))
    ...
    def _login(self):
        ...
        try:
            ...
            self._status.config(text="Cannot connect to server. Is the backend running?")
